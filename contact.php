  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="tel" class="form-control"   name="phone" placeholder="Phone(optinal) +2547"/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0746404011</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; located in kirinyaga around mwea along meru-Nairobi Highway <br>(24*7 Days)
